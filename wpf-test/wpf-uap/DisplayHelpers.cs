...
namespace wpf_uap
{
    ...
    public class DeviceInformationDisplay : INotifyPropertyChanged
    {
        ...
        private async void UpdateGlyphBitmapImage()
        {
            ...
            //TODO:NOTE: .NET Core no longer native support Windows.UI.Xaml namespace migrated to MAUI
            // refer to https://learn.microsoft.com/en-us/dotnet/desktop/wpf/advanced/xaml-namespaces-and-namespace-mapping-for-wpf-xaml?view=netframeworkdesktop-4.8
            // refer to https://learn.microsoft.com/en-us/dotnet/maui/user-interface/controls/image
            // try https://learn.microsoft.com/en-us/dotnet/standard/io/how-to-convert-between-dotnet-streams-and-winrt-streams
